...
export default function FileViewer({ onCancel }: FileViewerProps) {
  const messageState = useMessage();
  const message = messageState?.message as SendBird.FileMessage;
  const onDelete = messageState?.onDelete;
  const {
    sender,
    type,
    url,
