...
var index = require('./index-8ed9a864.js');
var index$1 = require('./index-fc52a694.js');
...
var getCreatedAt$1 = (function (createdAt) {
  ...
  if (index.isToday(createdAt)) {
    return LocalizationContext.format(createdAt, 'p');
  }
  ...
  return LocalizationContext.format(createdAt, 'MMM dd');
});
