...
var index$1 = require('./index-8564d0f0.js');
var index$2 = require('./index-c7e4e7bf.js');
var index$3 = require('./index-9b1c0c92.js');
var index$4 = require('./index-2ef8e7a2.js');
require('prop-types');
require('./index-0091f7a3.js');
require('react-dom');
...
function OpenchannelUserMessage(_a) {
  ...
  }, message.createdAt && LocalizationContext.format(message.createdAt, 'p'))), /*#__PURE__*/React__default["default"].createElement("div", {
...
function MessageHoc(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    type: index$2.LabelTypography.CAPTION_2,
    color: index$2.LabelColors.ONBACKGROUND_2
  }, LocalizationContext.format(message.createdAt, 'MMMM dd, yyyy'))), (_b = {}, _b[MessageTypes.ADMIN] = function () {
    if (message.messageType === 'admin') {
