...
var index$1 = require('./index-9b1c0c92.js');
var index = require('./index-0091f7a3.js');
var index$2 = require('./index-8564d0f0.js');
var index$3 = require('./index-c7e4e7bf.js');
var index$4 = require('./index-2ef8e7a2.js');
var index$5 = require('./index-77b8bc9f.js');
require('react-dom');
    ...
    case ON_MESSAGE_RECEIVED:
      {
        ...
        return LocalizationContext._objectSpread2(LocalizationContext._objectSpread2({}, state), {}, {
          ...
          unreadSince: _unreadCount === 1 ? LocalizationContext.format(new Date(), 'p MMM dd') : unreadSince,
          allMessages: passUnsuccessfullMessages(state.allMessages, message)
        });
      }
...
function MessageStatus(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, showMessageStatusIcon && /*#__PURE__*/React__default["default"].createElement("div", null, status === MessageStatusTypes.PENDING ? /*#__PURE__*/React__default["default"].createElement(index$3.Loader, {
    ...
    className: "sendbird-message-status__icon",
    type: iconType[status] || index$3.IconTypes.ERROR,
    fillColor: iconColor[status],
    width: "16px",
    height: "16px"
  })), index.isSentStatus(status) && /*#__PURE__*/React__default["default"].createElement(index$3.Label, {
...
function FileMessageItemBody(_a) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    type: {
      IMAGE: index$3.IconTypes.PHOTO,
      VIDEO: index$3.IconTypes.PLAY,
      AUDIO: index$3.IconTypes.FILE_AUDIO,
      GIF: index$3.IconTypes.GIF,
      OTHERS: index$3.IconTypes.FILE_DOCUMENT
...
function MessageContent(_a) {
  ...
  React__default["default"].createElement(index$1.ContextMenu, {
    ...
    type: index$3.LabelTypography.CAPTION_3,
    color: index$3.LabelColors.ONBACKGROUND_2
  }, index.getMessageCreatedAt(message)))), /*#__PURE__*/React__default["default"].createElement("div", {
...
function MessageHoc(_ref) {
  ...
  if (RenderedMessage) {
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      type: index$3.LabelTypography.CAPTION_2,
      color: index$3.LabelColors.ONBACKGROUND_2
    }, LocalizationContext.format(message.createdAt, 'MMMM dd, yyyy'))), /*#__PURE__*/React__default["default"].createElement(RenderedMessage, {
      message: message
    }));
  }
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    type: index$3.LabelTypography.CAPTION_2,
    color: index$3.LabelColors.ONBACKGROUND_2
  }, LocalizationContext.format(message.createdAt, 'MMMM dd, yyyy'))), /*#__PURE__*/React__default["default"].createElement(MessageContent, {
